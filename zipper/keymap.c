...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    MOUSE,   KC_LCTL, KC_LALT, KC_LGUI, M_EMHL, KC_SPC, KC_SPC, M_KHKR, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_TILD, KC_PIPE,
...
[_MOUSE] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, _______, KC_WH_D, KC_BTN1, KC_BTN2, KC_WH_U, _______, _______,
